    ...
    <div className="detail-container">
      ...
      <div className="detail-content">
        <div className="detail-section-card">
          <h3 className="detail-section-title">1. 인사말</h3>
        ...
        <div className="detail-section-card">
          <h3 className="detail-section-title">2. 주요 활동</h3>
          <p className="detail-section-body">
        ...
        <div className="detail-section-card">
          <h3 className="detail-section-title">3. 교육 분야</h3>
          <p className="detail-section-body">
        ...
        <div className="detail-section-card">
          <h3 className="detail-section-title">4. 자격 및 전문성</h3>
          <p className="detail-section-body">
        ...
        <div className="detail-section-card">
          <h3 className="detail-section-title">5. 저서와 수상</h3>
          <p className="detail-section-body">
        ...
        <div className="detail-section-card">
          <h3 className="detail-section-title">6. 교육 철학</h3>
          <p className="detail-section-body detail-highlight">
